...
import { ref } from 'vue'
import type { AiSessionDto } from '@/apis/domain/model/dto'
import { api } from '@/utils/api-instance'
import type { AiMessageInput, AiSessionInput } from '@/apis/domain/model/static'
import { ElMessageBox } from 'element-plus'

export type AiSession = Pick<AiSessionDto['AiSessionDto'], 'id' | 'name' | 'editedTime'> & {
  messages: AiMessage[]
}
